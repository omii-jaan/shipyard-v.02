    ...
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        [
          ...
          'data-inset:ps-8',
          'data-[variant=destructive]:text-[var(--text-error)]',
          'data-[variant=destructive]:focus:bg-[var(--bg-error)]',
          'data-[variant=destructive]:focus:text-[var(--text-error)]',
          'dark:data-[variant=destructive]:focus:bg-[var(--bg-error)]',
          '[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*="size-"])]:size-4',
          '[&_svg:not([class*="text-"])]:text-[var(--text-tertiary)]',
          'data-[variant=destructive]:*:[svg]:text-[var(--text-error)]',
        ],
        className
      )}
      {...props}
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        [
          'relative flex cursor-default items-center gap-2',
          'rounded-[var(--radius-sm)] py-1.5 ps-8 pe-2',
          'text-[var(--text-body-sm)]',
          'outline-none select-none',
          'focus:bg-[var(--bg-hover)] focus:text-[var(--text-primary)]',
          'data-disabled:pointer-events-none data-disabled:opacity-50',
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn('px-2 py-1.5 text-[var(--text-caption)] font-medium data-inset:ps-8', className)}
      {...props}
    />
  )
}
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn('ms-auto text-[var(--text-micro)] tracking-widest text-[var(--text-tertiary)]', className)}
      {...props}
    />
  )
}
